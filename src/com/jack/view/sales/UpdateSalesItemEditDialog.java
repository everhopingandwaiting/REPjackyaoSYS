...
public class UpdateSalesItemEditDialog extends JDialog
{
 ...
 private    SalesItem purchaseItem=new SalesItem();
  ...
  public UpdateSalesItemEditDialog(SalesItem item,int selectTableRow) {
  ...
  public void createContentPanel(JPanel cp) {
    ...
    addComponentListener(new ComponentAdapter()
    {
      public void componentShown(ComponentEvent e) {
        List list = UpdateSalesItemEditDialog.this.prodDao.findAll();
       prod_model = new DefaultComboBoxModel(new Vector(list));
        ...
        UpdateSalesItemEditDialog.this.cbx_prod.addItemListener(new ItemListener()
        {
          public void itemStateChanged(ItemEvent e) {
            if (e.getStateChange() == 1) {
              Product prod = (Product)UpdateSalesItemEditDialog.this.cbx_prod.getSelectedItem();
              UpdateSalesItemEditDialog.this.tfd_price.setText(UpdateSalesItemEditDialog.this.nf.format(prod.getSale_price().doubleValue()));
            }
          }
        });
      }
  ...
  public void createBtnPanel(JPanel cp)
  {
    ...
    jbt2.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent e) {
        if (UpdateSalesItemEditDialog.this.cbx_prod.getItemCount() >= 0) {
          UpdateSalesItemEditDialog.this.cbx_prod.setSelectedIndex(0);
        }
        UpdateSalesItemEditDialog.this.tfd_num.setText("1");
      }
    });
    btnPanel.add(jbt2);
