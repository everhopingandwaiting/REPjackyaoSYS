...
public class AddPurchaseItemEditDialog extends JDialog
{
...
private int selectTableRow;
  ...
  public AddPurchaseItemEditDialog(PurchaseItem purchaseItem,int selectTableRow) {
	 
  super(MainFrame.getInstance(), "编辑采购明细", true);
	 // setTitle("编辑采购明细");
    	this.purchaseItem=purchaseItem;
    	this.selectTableRow=selectTableRow; System.out.println(selectTableRow+" ;;;;;;;;;;;");
  ...
  public void createContentPanel(JPanel cp) {
    ...
    addComponentListener(new ComponentAdapter()
    {
      public void componentShown(ComponentEvent e) {
        List list = AddPurchaseItemEditDialog.this.prodDao.findAll();
       prod_model = new DefaultComboBoxModel(new Vector(list));
        ...
        AddPurchaseItemEditDialog.this.cbx_prod.addItemListener(new ItemListener()
        {
          public void itemStateChanged(ItemEvent e) {
            if (e.getStateChange() == 1) {
              Product prod = (Product)AddPurchaseItemEditDialog.this.cbx_prod.getSelectedItem();
              AddPurchaseItemEditDialog.this.tfd_price.setText(AddPurchaseItemEditDialog.this.nf.format(prod.getSale_price().doubleValue()));
            }
          }
        });
      }
  ...
  public void createBtnPanel(JPanel cp)
  {
    ...
    jbt2.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent e) {
        if (AddPurchaseItemEditDialog.this.cbx_prod.getItemCount() >= 0) {
          AddPurchaseItemEditDialog.this.cbx_prod.setSelectedIndex(0);
        }
        AddPurchaseItemEditDialog.this.tfd_num.setText("1");
      }
    });
    btnPanel.add(jbt2);
  ...
  private void doAdd() {
    ...
    AddPurchaseDialog.getInstance().model.update(selectTableRow, item);
