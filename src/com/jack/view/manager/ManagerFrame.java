...
import com.jack.model.ManagerTableModel;
 ...
 * @author solo
 */
public class ManagerFrame extends JInternalFrame {
	private static final long serialVersionUID = 3641881158731346878L;
	private static ManagerFrame frame = new ManagerFrame();
	...
	public ManagerTableModel model;
	private Manager selectedMgr;
	...
	private void createButtonPanel(){
		...
		btn_add.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AddManagerDialog.getInstance().setVisible(true);;
			}
		});
		...
		btn_update.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(selectedMgr != null){
					new UpdateManagerDialog(MainFrame.getInstance(), selectedMgr);
				}else{
